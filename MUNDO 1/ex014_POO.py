...
class conversoes:
    ...
    Celsius_to_Kelvin = lambda
    Celsius_to_Fahrenheit = lambda
    Fahrenheit_to_Celsius = lambda
    Fahrenheit_to_Kelvin = lambda
    Kelvin_to_Celsius = lambda
    Kelvin_to_Fahrenheit = lambda
    


mensagem_de_entrada = "CONVERSOR DE TEMPERATURAS"


print(mensagem_de_entrada)
